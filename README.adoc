...
image::https://github.com/saurabhshri/saurabhshri.github.io/raw/master/images/karaoke.gif?raw=true[align="center", "Synced output in Karaoke Style", height = "360px"]


- _Here's a quick video showing the output of approximated alignment :_

[link=https://www.youtube.com/watch?v=km1iHe_mGuo]
image::https://img.youtube.com/vi/km1iHe_mGuo/0.jpg["Click to watch the video on YouTube!", align="center"]
== Usage Parameters ==
