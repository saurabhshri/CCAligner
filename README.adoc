...
In case you have some trouble with dependencies, I have mirrored the last known working versions of them in the repository at : _(ttps://github.com/saurabhshri/mirror/)_ .
